...
- Durable archive-worker composition around the Telegram media downloader; video cover/representative-frame extraction; and protected-content handling beyond the download boundary. Image-asset metadata and the standalone downloader are implemented, but no live worker composes the full download/normalize/archive lifecycle yet.

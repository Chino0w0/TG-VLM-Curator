...
class AlembicOfflineSqlTests(unittest.TestCase):
    ...
    def test_migrations_render_postgresql_ddl_without_connecting(self) -> None:
        ...
        self.assertIn("ck_image_asset_archive_lease", result.stdout)
        self.assertIn("ck_image_asset_failure_reason", result.stdout)
        self.assertIn("ix_image_assets_pending_archive_lease", result.stdout)

...
class ImageArchiveMetadataRepositoryStatementTests(unittest.TestCase):
    ...
    def test_image_asset_upsert_creates_only_image_assets(self) -> None:
        image_message = normalize_telegram_messages(
            (
                TelegramMessage(
        ...
        text_message = normalize_telegram_messages(
            (
                TelegramMessage(
                    source_channel_id=str(uuid4()),
    ...
    def test_image_asset_schema_contains_ready_invariants(self) -> None:
        ...
        self.assertIn("ck_image_assets_image_asset_archive_state", constraints)
        self.assertIn("ck_image_assets_image_asset_source_message_positive", constraints)
        self.assertIn("ck_image_assets_image_asset_ready_metadata", constraints)
        self.assertIn("ck_image_assets_image_asset_deleted_timestamp", constraints)
